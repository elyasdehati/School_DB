                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown dropstart dropend dropup">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink{{ $item->id }}">
                                                                <li><a class="dropdown-item" href="{{ route('edit.infas',$item->id) }}">Edit</a></li>
                                                                <li>
                                                                    <a href="{{ route('delete.infas',$item->id) }}" class="dropdown-item text-danger delete-confirm">
                                                                        Delete
                                                                    </a>
                                                                </li>
                                                            </ul>
