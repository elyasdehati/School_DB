        ...
        <div class="card mt-1">
            ...
            <div class="card-header">
                <div class="d-flex align-items-sm-center flex-sm-row flex-column">
                    ...
                    <div class="text-end">
                        <a href="{{ route('add.class.type') }}" class="btn btn-secondary">Add Class Type</a>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown dropstart dropend dropup">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink{{ $item->id }}">
                                                                <li><a class="dropdown-item" href="{{ route('edit.class.type',$item->id) }}">Edit</a></li>
                                                                <li>
                                                                    <a href="{{ route('delete.class.type',$item->id) }}" class="dropdown-item text-danger delete-confirm">
                                                                        Delete
                                                                    </a>
                                                                </li>
                                                            </ul>
