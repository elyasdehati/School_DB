        ...
        <div class="card mt-1">
            ...
            <div class="card-header">
                <div class="d-flex align-items-sm-center flex-sm-row flex-column">
                    ...
                    <div class="text-end">
                        <a href="{{ route('add.language') }}" class="btn btn-secondary">Add Language</a>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown dropstart dropend dropup">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink{{ $item->id }}">
                                                                <li><a class="dropdown-item" href="{{ route('edit.language',$item->id) }}">Edit</a></li>
                                                                <li>
                                                                    <a href="{{ route('delete.language',$item->id) }}" class="dropdown-item text-danger delete-confirm">
                                                                        Delete
                                                                    </a>
                                                                </li>
                                                            </ul>
