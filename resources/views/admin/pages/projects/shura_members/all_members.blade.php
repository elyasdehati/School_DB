                ...
                <div class="card-header">
                    <div class="d-flex align-items-sm-center flex-sm-row flex-column">
                        ...
                        <div class="text-end me-2">
                            <form action="{{ route('import.projects.shura.members', $project->id) }}" method="POST" enctype="multipart/form-data" class="d-inline">
                                @csrf
                            ...
                            <a href="{{ route('export.projects.shura.member', [$project->id, 'template']) }}" 
                            class="btn btn-info btn-sm">
                                Download Template
                            </a>

                            <a href="{{ route('export.projects.shura.member', [$project->id, 'data']) }}" 
                            ...
                            $rows[] = [
                                ...
                                '<div class="dropdown dropstart dropend dropup">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink'.$item->id.'">
                                        ...
                                        <li>
                                            <a href="' . route('delete.projects.shura.members', $item->id) . '" 
