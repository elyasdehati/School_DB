...
class ProjectsController extends Controller
{
    ...
    public function AllProjectsClass($id){
        ...
        return view('admin.pages.projects.classes.all_classes', compact('project', 'class', 'nextClassId', 'provinces', 'districts', 'languages', 'classtype', 'statuses', 'infrastructures'));
    }
    ...
    public function exportClasses($id, $type){
        ...
        return Excel::download(
            ...
            $withData ? 'classes_with_data.xlsx' : 'classes_template.xlsx'
        );
    }
    ...
    public function exportStudents($id, $type){
        ...
        return Excel::download(
            ...
            $withData ? 'students_with_data.xlsx' : 'students_template.xlsx'
        );
    }
