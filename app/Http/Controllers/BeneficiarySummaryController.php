...
use App\Exports\AllBeneficiarySummaryExport;
...
class BeneficiarySummaryController extends Controller
{
    ...
    public function ExportAllBeneficiarySummary()
    {
        $classes = ProjectClass::with(['project', 'province', 'district'])
            ->orderBy('project_id')
            ->orderBy('province_id')
        ...
        return Excel::download(
            new AllBeneficiarySummaryExport($reportData),
            'all_beneficiary_summary.xlsx'
        );
    }
}